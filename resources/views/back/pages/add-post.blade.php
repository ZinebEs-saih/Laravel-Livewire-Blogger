...
<div class="page-header d-print-none">
  ...
  <form method="Post" id="createPost" action="{{route('authorpostscreatePost')}}" enctype="multipart/form-data">
    @csrf
    <div class="card">
        <div class="card-body">
           <div class="row">
            <div class="col-md-9">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="post_content" placeholder="content... " rows="6" id="post_content" >
                    </textarea>   
